...
<body >
  <div class="container">
 <form:form class="form-horizontal"  method="post"  action="addVirtualPerson.htm" commandName="virtualPerson" enctype="multipart/form-data">
...
<div class="col-sm-10">
<button class="btn btn-success form-control" type="submit">Create Virtual Person</button>
</div>
