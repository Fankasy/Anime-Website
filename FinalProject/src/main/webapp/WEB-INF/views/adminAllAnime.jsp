      ...
      <table class="table  ">
        ...
        <c:forEach var="a" items="${animes}">
         <tr >
          ...
          <button type="submit" class="btn btn-primary"  onclick="window.location.href='manageAnimeDetail.htm?animeID=${a.animeID}'">Manage</button>
          
          <form action="deleteAnime.htm?animeID=${a.animeID}" method="POST">
