...
<body >
  <div class="container">
    <form:form class="form-horizontal" action="addActualPerson.htm" method="POST" commandName="actualPerson" enctype="multipart/form-data">
...
<div class="col-sm-10">
<button class="btn btn-success form-control" type="submit">Create Actual Person</button>
</div>
