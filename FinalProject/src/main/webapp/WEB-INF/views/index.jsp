		...
		<div class="container">
			...
			<div
				...
				<ul class="nav navbar-nav drop-down">
					...
					<li><a class="page-scroll" href="allanime.htm">All Anime</a>
					</li>
					<li><a class="page-scroll" href="allGroup.htm">Groups</a></li>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<h1 class="brand-heading">FantasyAnime</h1>

						
					</div>
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							<form action="searchAnime.htm" method="GET">
								<label class="radio-inline"> <input type="radio" name="searchType"  value="title"/>
									Title
								</label> <label class="radio-inline"> <input type="radio" name="searchType"  value="description"/>
									Description
								</label> <label class="radio-inline"> <input type="radio" name="searchType"  value="production"/>
									Production
								</label> <input type="text" class="form-control" placeholder="Search for Anime" name="key"/>
									 <button class="btn btn-circle page-scroll">
