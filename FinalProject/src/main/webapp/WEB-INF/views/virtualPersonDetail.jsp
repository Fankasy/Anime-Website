	...
	<header>
		<div class="container ">
			<div class="row">
				<div class="col-md-6">
					<br /> <br /> <br />
					<div>
						<img src="file://${virtualPerson.fileName }" height="450px"
							width="550px" />
					</div>
				</div>
				<div class="col-md-6 ">
					...
					<div class="row">
						<p>Name: ${virtualPerson.fname} &nbsp ${virtualPerson.lname}</p>
					</div>

					<div class="row">
						<p>Age： ${virtualPerson.age}</p>
					</div>


					<div class="row">
						<p>Born Place: ${virtualPerson.bornplace}</p>
					</div>


					<div class="row">
						<p>Height: ${virtualPerson.height}</p>
					</div>


					<div class="row">
						<p>Weight: ${virtualPerson.weight}</p>
					</div>
					<div class="row">
						<p>Gender: ${virtualPerson.gender}</p>
					</div>
		...
		<div class="container">
			<table class="table  ">
				...
				<tbody>
					<c:forEach var="a" items="${virtualPerson.animeCharacters}">
						<tr>
