...
<body >
  <div class="container">
        <input type="hidden" class="form-control" name="id"  value="${ActualpersonId}" placeholder="${ActualpersonId }"/>
  
    <form:form class="form-horizontal" action="manageActualPersonDetail.htm" method="POST" commandName="actualPerson" enctype="multipart/form-data">
