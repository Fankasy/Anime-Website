        ...
        <div class="intro-body">
            <div class="container">
              <form:form action="login.htm" method="POST" commandName="user" >
                ...
                <div class="row">
                      <div class="col-md-4 col-md-offset-4">
                        UserName: <form:input type="text" class="form-control" placeholder="Username" name="userName" path="userName" /><form:errors path="userName"/>
                ...
                <div class="row">
                	<div class="col-md-4 col-md-offset-4">
                	PassWord: <form:input type="password" class="form-control" placeholder="PassWord" name="password" path="password"/><form:errors path="password"/>
                	</div>
                </div>
                <br/>
                <div class="row">
                	<div class="col-md-4 col-md-offset-4">
                	<button class="btn btn-success form-control btn-lg">Login</button>
                	</div>
                ...
                <div class="row">
                <div class="col-md-4 col-md-offset-4">
                <button class="btn btn-info form-control btn-lg">Register</button>
                </div>
                </div>
                </form>
            </div>
